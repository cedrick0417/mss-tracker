...
class RalTableModel
{
    ...
    public function getFilterValues()
    {
        ...
        $query = $this->db->query("SELECT DISTINCT status FROM raltable");
    ...
    public function getTotalRows($searchKeyword, $filterValue)
    {
        ...
        $sql = "SELECT COUNT(*) as total FROM raltable";
        ...
        if (!empty($searchKeyword) || !empty($filterValue)) {
            ...
            if (!empty($searchKeyword)) {
                $sql .= "confirmation_no LIKE '%$searchKeyword%' OR website_address LIKE '%$searchKeyword%' AND ";
            }
